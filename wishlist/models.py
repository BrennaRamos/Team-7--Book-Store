...
class WishlistName(models.Model):
    username = models.CharField(max_length=20, help_text='Placeholder till user ID ready',  primary_key=True)
...
class WishlistEntrie(models.Model):
    username = models.CharField(max_length=20, help_text='Placeholder till user ID ready')
